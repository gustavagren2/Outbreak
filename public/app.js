...
// ---------- State ----------
let state = {
  you:null, host:false, phase:'LOBBY',
...
function drawMiniSprite(ctx, cx, cy, color, infected, moving, dt, tx, ty){
  ...
  if (infected){
    ...
    ctx.fillRect(x0+2,  yL, 6, 3);
    ctx.fillRect(x0+32, yR, 6, 3);
  }
