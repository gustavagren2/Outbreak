...
function ensureDefaultRoom(){
  ...
  room = {
    ...
    options: {
      ...
      boardMs: 6000,
      minPlayers: 3,
      points: { survivalPerSec: 1, perInfection: 25, p0FullInfectBonus: 50 }
    },
    scores: new Map()
  };
...
function startNextRound(room){
  room.round += 1;
  if (room.round > room.totalRounds){ room.phase = PHASE.END; broadcastRoom(room); return; }
...
io.on('connection', (socket)=>{
  // auto-join the single shared room
